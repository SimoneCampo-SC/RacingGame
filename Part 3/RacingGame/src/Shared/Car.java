...
public class Car implements Serializable {
    ...
    private transient Clip crashSound, engineSound;
    ...
    public Car(String root, String carName, int x, int y) {
        ...
        try {
            AudioInputStream carCrashAudioInputStream = AudioSystem.getAudioInputStream(getClass().getResource("carProperties/crash.wav"));
            crashSound = AudioSystem.getClip();
            crashSound.open(carCrashAudioInputStream);

            AudioInputStream carEngineAudioInputStream = AudioSystem.getAudioInputStream(getClass().getResource("carProperties/carEngine.wav"));
